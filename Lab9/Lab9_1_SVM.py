...
Original file is located at
    https://colab.research.google.com/drive/15Lyv6Lcsv9ENM5dMsZ6goLSybKuL0R3X
...
X, Y = make_blobs(n_samples=500, centers=2, random_state=57, cluster_std=0.40)
...
X_train, X_test, y_train, y_test = train_test_split(cancer.data, cancer.target, test_size = 0.2,random_state=57)

#Import svm model
from sklearn import svm

#Create a svm Classifier
clf = lsc = svm.SVC(kernel='linear') # Linear Kernel
